...
export const AddLinkedin = () => {
    ...
    return (
        <div className="px-3">
            <form onSubmit={handleSubmit} className="flex flex-col justify-center  border-teal-500 py-2">
                ...
                <button type="submit" className="bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded mt-2">Send User</button>
            </form>
            <div className="text-white">
                <div className="text-orange-400"> Bilgilendirme </div>
                <div> Link kısmına varsayılan value nun devamına kullanıcı adınızı ekleyebilirsiniz.</div>
                <div> <span className="text-orange-400">↓</span> Kabul edilen link formatları <span className="text-orange-400">↓</span></div>
